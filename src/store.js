...
export default new Vuex.Store({
  state: {
    navBar:[
      ...
      {name:'数据导入',icon:'ios-cloud-download',fz:24,children:[{name:'数据导入',icon:'',fz:24 ,to:{ name: 'importdata'}}]},
      {name:'成果目录',icon:'md-trophy',fz:24,children:[{name:'成果目录',icon:'',fz:24 ,to:{ name: 'achievement'}}]},
      {name:'数据提取',icon:'ios-paper',fz:24,children:[{name:'数据提取',icon:'',fz:24 ,to:{ name: 'dataview'}}]},
    ]
  },
  mutations: {
